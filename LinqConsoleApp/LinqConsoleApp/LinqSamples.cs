    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task1()
        {
            ...
            var res2 = Emps.Where(e => e.Job.Equals("Backend programmer"))
                .Select(e => new
                {
                    Nazwisko = e.Ename,
                    Zawod = e.Job
        ...
        public void Task2()
        {
            ...
            //2. Lambda and Extension methods
            var res2 = Emps.Where(e => e.Job.Equals("Frontend programmer") && e.Salary > 1000)
        ...
        public void Task4()
        {
            var res = Emps.Where(e => e.Salary == Emps.Max(c => c.Salary));
        }
        ...
        public void Task6()
        {
            ...
            var res = Emps.Join(Depts, e => e.Deptno, q => q.Deptno, (r, w) => new { r, w });
        }
